...
vim.keymap.set("n", "<leader>fb", '<cmd>Telescope ctags_outline buf=all<cr>', { desc = 'Telescope ctags on all buffers' })
vim.keymap.set("n", "<leader>fc", builtin.buffers, { desc = 'Telescope buffers' })
vim.keymap.set('n', '<leader>fd', '<cmd>Telescope frecency workspace=CWD<cr>',
